...
public abstract class Task {
	...
	/*
	 * public void informOnExit(Mailbox<ExitMsg> exit) { exitMB = exit; }
	 */
	 ...
	 */
	@pausable
	public static void pause(PauseReason pr) {
		errNotWoven();
	}
	...
	public void _runExecute() {
		...
		if (isDone) {
			// inform on exit
			/*
			 * if (exitMB != null) { Object exitMsg = "OK"; if (pauseReason
			 * instanceof TaskDoneReason) { exitMsg =
			 * ((TaskDoneReason)pauseReason).exitObj; } exitMB.putnb(new
			 * ExitMsg(id, exitMsg)); }
			 */
		} else {
