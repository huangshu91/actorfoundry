...
public class TypeDesc {
	static final HashMap<String, String> knownTypes = new HashMap<String, String>(
			30);
	...
	public static String mergeType(String a, String b)
		...
		case '[':
			if (bc == '[') {
				try {
					return "["
							+ mergeType(TypeDesc.getComponentType(a), TypeDesc
									.getComponentType(b));
	...
	private static String toDesc(String name) {
		return (name.equals(JAVA_LANG_OBJECT)) ? D_OBJECT : "L"
				+ name.replace('.', '/') + ';';
	}
