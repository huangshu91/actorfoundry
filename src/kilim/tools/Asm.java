...
public class Asm {
	...
	private static Pattern superPattern = Pattern
			.compile("\\.super ([\\w/]+)$");
	...
	private static Pattern implementsPattern = Pattern
			.compile("\\.implements ([\\w/]+)$");
	...
	// The field declaration "public final String fileName = "foobar" is
	// declared as
	...
	private void parseField() {
		...
		Object value = valueStr == null ? null : parseValue(valueStr, (desc
				.equals(D_DOUBLE) || desc.equals(D_LONG)));
	...
	private static Pattern throwsPattern = Pattern
			.compile("^.throws +([\\w+/])");
	...
	private void checkLabelDeclarations() {
		for (String key : labels.keySet()) {
			if (!declaredLabels.contains(key)) {
				throw new AsmException("Label " + key + " not declared in "
						+ methodName);
			}
		}
	}
	...
	static Pattern catchPattern = Pattern
			.compile(".catch +([\\w/]+) +from +([\\w]+) +to +([\\w]+) +using +([\\w]+)");
	static Pattern annotationPattern = Pattern
			.compile(".annotation +((visible) )?([\\w/;]+)");
	...
	private void parseMethodDirective() {
		if (lineMatch(localsPattern)) {
			...
			mv
					.visitTryCatchBlock(fromLabel, toLabel, usingLabel,
							exceptionType);
		} else if (lineMatch(annotationPattern)) {
			parseAnnotation();
		} else {
	...
	static String opcodeStrs[] = { "nop", "aconst_null", "iconst_m1",
	...
	static {
		...
		visitTypes = new byte[] { INSN, INSN, INSN, INSN, INSN, INSN, INSN,
				INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN, INT, INT,
				LDC, LDC, LDC, VAR, VAR, VAR, VAR, VAR, INSN, INSN, INSN, INSN,
				INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN,
				INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN,
				INSN, INSN, INSN, INSN, VAR, VAR, VAR, VAR, VAR, INSN, INSN,
				INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN,
				INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN,
				INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN,
				INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN,
				...
				INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN,
				INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN,
				INSN, IINC, INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN,
				INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN, INSN,
				INSN, INSN, JUMP, JUMP, JUMP, JUMP, JUMP, JUMP, JUMP, JUMP,
				JUMP, JUMP, JUMP, JUMP, JUMP, JUMP, JUMP, JUMP, VAR,
				TABLESWITCH, LOOKUPSWITCH, INSN, INSN, INSN, INSN, INSN, INSN,
				FIELD, FIELD, FIELD, FIELD, METHOD, METHOD, METHOD, METHOD,
				INSN, TYPE, INT, TYPE, INSN, INSN, TYPE, TYPE, INSN, INSN,
				INSN, MULTIANEWARRAY, JUMP, JUMP, JUMP, JUMP };
	}
	...
	static final Pattern methodSpecPattern = Pattern
			.compile("([\\w/]+)[/.]([<>\\w]+) *([(].*)");
	static final Pattern fieldSpecPattern = Pattern
			.compile("([\\w/]+)[/.]([\\w$]+) +([^\\s]+)");
